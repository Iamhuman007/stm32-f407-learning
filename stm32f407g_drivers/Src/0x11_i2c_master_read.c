...
int main(void)
{
	 ...
	 while(1)
	{
		...
		I2C_MasterSendData(&I2C1Handle, &CMD_Len, 1, SLAVEADDR,I2C_ENABLE_SR);
...
//		delay();
		...
		I2C_MasterSendData(&I2C1Handle, &CMD_Data, 1, SLAVEADDR, I2C_ENABLE_SR);
		I2C_MasterReceiveData(&I2C1Handle, Data, Len, SLAVEADDR, I2C_DISABLE_SR);
